...
class Type:
    ...
    def get_cl_vec_type(self, burst_width: int) -> str:
        ...
        assert (
            self._val in HAODA_TYPE_TO_CL_TYPE), "scalar type not supported"

        return HAODA_TYPE_TO_CL_TYPE[self._val] + str(
            burst_width // scalar_width)
